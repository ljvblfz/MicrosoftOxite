...
namespace Oxite.Modules.Membership.Repositories.SqlServer
{
    public class SqlServerUserRepository : IUserRepository
    {
        ...
        public SqlServerUserRepository(OxiteMembershipDataContext context, OxiteContext oxiteContext)
        {
        ...
        public User Save(User user)
        {
            ...
            return GetUser(userToSave.Username);
        }

        public bool Remove(User user)
        {
            oxite_User foundUser = context.oxite_Users.FirstOrDefault(u => u.UserID == user.ID && u.Status != (byte)EntityState.Removed);
        ...
        private User projectUser(Guid siteID, oxite_User user)
        {
            var siteRoles =
            ...
            return new User(user.UserID, user.Username, user.DisplayName, user.Email, user.HashedEmail, (EntityState)user.Status, siteRoles.ToList(), Enumerable.Empty<KeyValuePair<Guid, Role>>(), Enumerable.Empty<KeyValuePair<Guid, Role>>(), Enumerable.Empty<KeyValuePair<Guid, Role>>());
        }
