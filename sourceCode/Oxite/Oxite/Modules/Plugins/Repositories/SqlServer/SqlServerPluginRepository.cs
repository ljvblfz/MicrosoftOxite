...
namespace Oxite.Modules.Plugins.Repositories.SqlServer
{
    public class SqlServerPluginRepository : IPluginRepository
    {
        ...
        public SqlServerPluginRepository(OxitePluginsDataContext context, OxiteContext oxiteContext)
        {
        ...
        public Plugin Save(Plugin plugin)
        {
            ...
            return GetPlugin(pluginToSave.PluginID);
        }
        ...
        private Plugin projectPlugin(oxite_Plugin plugin)
        {
        ...
        private IQueryable<oxite_Plugin> getPluginsQuery()
        {
