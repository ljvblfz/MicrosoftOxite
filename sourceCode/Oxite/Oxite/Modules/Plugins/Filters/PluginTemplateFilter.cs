...
namespace Oxite.Modules.Plugins.Filters
{
    public class PluginTemplateFilter : IActionFilter, IResultFilter
    {
        ...
        {
            ViewDataDictionary newViewData = new ViewDataDictionary(context.Controller.ViewData);
            ViewPage viewPage = new ViewPage() { ViewContext = new ViewContext(context, ((ViewResult)context.Result).View, newViewData, context.Controller.TempData), ViewData = newViewData };
