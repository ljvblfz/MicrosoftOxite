...
namespace Oxite.Modules.Core.Controllers
{
    public class SiteController : Controller
    {
        ...
        public SiteController(AppSettingsHelper appSettings, ISiteService siteService, IUserService userService/*, IBlogService blogService*/, ILanguageService languageService)
        {
            oxiteInstanceName = appSettings.GetInstanceName();
