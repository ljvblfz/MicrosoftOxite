...
namespace Oxite.Extensions
{
    public static class UrlHelperExtensions
    {
        ...
        public static string UserChangePassword(this UrlHelper urlHelper, User user)
        {
            return urlHelper.RouteUrl("UserChangePassword", new { userName = user.Name });
        }

        public static string UserRoles(this UrlHelper urlHelper, User user)
        {
        ...
        public static string UserEdit(this UrlHelper urlHelper, User user)
        {
            return urlHelper.RouteUrl("UserEdit", new { userName = user.Name });
        }

        public static string UserRemove(this UrlHelper urlHelper, User user)
        {
