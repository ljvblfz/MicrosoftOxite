...
namespace Oxite.Modules.Blogs.Models
{
    public class CommentInputForImport
    {
        ...
        private readonly User creatorAuthenticated;
        ...
        public CommentInputForImport(string body, DateTime created, User creator, long creatorIP, string creatorUserAgent, Language language, DateTime modified, EntityState state)
            : this(body, created, creatorIP, creatorUserAgent, language, modified, state)
        {
