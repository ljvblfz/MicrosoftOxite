...
{
    public static class PostTagExtensions
    {
        public static int GetTagWeight(this PostTag tag, IEnumerable<KeyValuePair<PostTag, int>> tagsWithPostCount, ref double? averagePostCount, ref double? standardDeviationOfPostCount)
        {
            return tag.GetTagWeight(tagsWithPostCount, ref averagePostCount, ref standardDeviationOfPostCount, 1, 7);
        }

        public static int GetTagWeight(this PostTag tag, IEnumerable<KeyValuePair<PostTag, int>> tagsWithPostCount, ref double? averagePostCount, ref double? standardDeviationOfPostCount, int? minWeight, int? maxWeight)
        {
