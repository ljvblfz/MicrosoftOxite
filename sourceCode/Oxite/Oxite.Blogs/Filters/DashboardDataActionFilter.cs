...
namespace Oxite.Modules.Blogs.Filters
{
    public class DashboardDataActionFilter : IActionFilter
    {
        ...
        public DashboardDataActionFilter(IPostService postService, IBlogsCommentService commentService)
        {
        ...
        public void OnActionExecuted(ActionExecutedContext filterContext)
        {
            ...
            {
                //recent posts - all up
                IEnumerable<Post> posts = postService.GetPostsWithDrafts(new PagingInfo(0, 5));

                //recent comments - all up
                IEnumerable<PostComment> comments = commentService.GetComments(new PagingInfo(0, 10), true, true);
