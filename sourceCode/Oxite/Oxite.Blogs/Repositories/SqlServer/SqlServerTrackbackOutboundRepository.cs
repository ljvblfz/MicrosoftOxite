...
{
    public class SqlServerTrackbackOutboundRepository : ITrackbackOutboundRepository
    {
        private OxiteBlogsDataContext context;

        public SqlServerTrackbackOutboundRepository(OxiteBlogsDataContext context)
        {
                    ...
                    trackbacks.Select(
                        tb =>
                            new oxite_TrackbackOutbound
                            {
                                ...
                                PostID = tb.PostID,
                                PostUrl = tb.PostUrl,
                                PostBlogTitle = tb.PostBlogTitle,
        ...
        public IEnumerable<TrackbackOutbound> GetNext(TimeSpan interval, int blockSize)
        {
            IEnumerable<TrackbackOutbound> trackbacks;
