...
namespace Oxite.Tests.Controllers
{
    public class UserControllerTests
    {
        ...
        public void SignInSetsCookieForValidUser()
        {
            ...
            UserController controller = new UserController(formsAuth, userService, null) { Url = helper };
        ...
        public void SignInRedirectsToUrlForNonNullReturnUrl()
        {
            ...
            UserController controller = new UserController(formsAuth, userService, null);
        ...
        public void SignInSetsModelStateErrorIfUserDoesNotExist()
        {
            ...
            UserController controller = new UserController(null, userService, null);
