...
namespace Oxite.Tests.Controllers
{
    public class PostControllerTests
    {
        ...
        public void ListBySearchSetsSearchContainerOnModel()
        {
            ...
            OxiteViewModelItems<Post> result = controller.ListBySearch(null, 0, new SearchCriteria() { Term = "test" }, null);
        ...
        public void ItemReturnsPost()
        {
            ...
            postService.AddedPosts.Add(new Post() { ID = postID, Slug = "Slug", Area = new Area() });
