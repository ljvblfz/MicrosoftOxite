...
namespace Oxite.Modules.Conferences.Models
{
    ...
    public class ScheduleItemComment : Comment, ICacheEntity, ISecureEntity
    {
        ...
        public ScheduleItemComment(string body, DateTime created, User creator, long creatorIP, string creatorUserAgent, Language language, DateTime modified, string slug, EntityState state)
            : base(body, created, creator, creatorIP, creatorUserAgent, language, modified, state)
        {
            Slug = slug;
        }

        public ScheduleItemComment(string body, DateTime created, User creator, long creatorIP, string creatorUserAgent, Guid id, Language language, DateTime modified, ScheduleItemCommentSmall parent, ScheduleItemSmall scheduleItem, string slug, EntityState state)
