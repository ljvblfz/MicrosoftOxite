...
/** markItUp - textarea editor **/
$(function() {
    if (!$.fn.markItUp) { return; }

    $("textarea.html").markItUp({
        nameSpace: "html editor",
        previewInWindow: null,
        previewTemplatePath: window.__markitupPreviewTemplatePath || '~/templates/preview.html',
        previewCssPath: window.__markitupPreviewCssPath,
