<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="../Shared/Site.master" Inherits="System.Web.Mvc.ViewPage<OxiteViewModelItem<Site>>" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    { %>
        ...
        <div><%=Html.Hidden("hasMultipleBlogs", Model.Item.ID == Guid.Empty ? false : Model.Item.HasMultipleBlogs) %></div>
        ...
        <div><%=Html.TextBox("skinsPath", m => m.Item.SkinsPath, "Skins Path", new { size = 60, @class = "text" })%></div>
        <div><%=Html.TextBox("skinsScriptsPath", m => m.Item.SkinsScriptsPath, "Scripts Path", new { size = 60, @class = "text" })%></div>
        <div><%=Html.TextBox("skinsStylesPath", m => m.Item.SkinsStylesPath, "Styles Path", new { size = 60, @class = "text" })%></div>
        <div><%=Html.TextBox("skin", m => m.Item.Skin, "Site Skin", new { size = 20, @class = "text" })%></div>
        <div><%=Html.TextBox("adminSkin", m => m.Item.AdminSkin, "Admin Skin", new { size = 20, @class = "text" })%></div>
        ...
        <div><%=Html.TextBox("pluginsPath", m => m.Item.PluginsPath, "")%> <label for="pluginsPath" class="checkbox">Plugins Path</label></div>
