...
namespace Oxite.Plugins.Models
{
    public class PostForProcessing
    {
        ...
        public Post ToPost()
        {
            return new Post(original.Blog, Body, Excerpt, original.CommentingDisabled, original.Created, original.Creator, original.ID, original.Modified, original.Published, Slug, original.State, original.Tags, Title, original.Comments, original.Trackbacks, original.Files);
        }
    }
}
