...
<%
    ...
    if (Model.PartialModel != null && Model.PartialModel.Media != null && Model.PartialModel.Preview != null)
    {
        ...
        var playerPath = Model.PartialModel.DefaultPlayerPath; // "/players/VideoPlayer2009_03_27.xap";
        if (isSmoothStreaming)
        {
            playerPath = Model.PartialModel.SmoothStreamingPlayerPath; // "/players/Microsoft.SilverlightMediaFramework.PDC.xap";
        }
