<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="../Shared/Site.master" Inherits="System.Web.Mvc.ViewPage<OxiteViewModelItems<UserAuthenticated>>" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server"><%
    ...
    { %>
        ...
        foreach (UserAuthenticated user in Model.Items)
        { %>
                        <li>
