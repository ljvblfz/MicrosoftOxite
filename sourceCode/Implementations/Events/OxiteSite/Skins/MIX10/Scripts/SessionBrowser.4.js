...
/// <reference path="/Scripts/Reform.js" />
...
pdc.sessionBrowser = {
    ...
    "sessions": {
        ...
        "init": function() {
            ...
            $("#currentSearch .closebutton").live("click", function() {
                pdc.sessionBrowser.sessions.clearSearchState();
                pdc.sessionBrowser.sessions.navigate();
                pdc.sessionBrowser.sessions.updateNavigation();
            });
            ...
            $("div.controlbar>form").bind("submit", function(e) {
                ...
                var searchValue = $("#filter", this).val();
                if (searchValue === 'Search Sessions' ||
                    $.trim(searchValue) == '') {
                    return;
                }
                _ps.filter.search = searchValue;
        ...
        "navigate": function(url) {
            ...
            pdc.sessionBrowser.sessions.setSearchState();
        ...
        "setSearchState": function() {
            ...
            if (searchValue.length < 1 || searchValue === 'Search Sessions') { return; }

            this.clearSearchState();

            $("#currentSearch").html("Search: <span class=\"current search\">" + HtmlEncode(searchValue) + "</span>&nbsp;<a class=\"closebutton\">&nbsp; &nbsp; &nbsp;</a>");

            this.setSearchStateImpl(searchValue);
        },
        "setSearchStateImpl": function(value) {
            var filter = pdc.sessionBrowser.sessions.filter;
            filter.search = value;
            $("#filter").val(value);
        },
