...
<asp:Content ContentPlaceHolderID="ContentHeader" runat="server"><div id="topnav"><h1><%=Model.Container.GetDisplayName() %></h1></div></asp:Content>
...
<asp:Content ContentPlaceHolderID="Scripts" runat="server"><%
    ...
    Html.RenderScriptTag("Sessions.js");                                                             
    %>
</asp:Content>
