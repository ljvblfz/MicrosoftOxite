...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%}%>
<div id="printThisPage"><% var printText = Model.Localize("PrinterFriendly", "Printer Friendly"); %>
    <a href="<%= Url.RouteUrl("EventSessionsMinePrintable") %>" target="_blank">
        <img src="<%= Url.Content("~/Skins/MIX10/Styles/img/icon-print.gif") %>" alt="Print" title="<%= printText %>"/>
        <%= printText %>
    </a>
</div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Title" runat="server">
    <%=Html.PageTitle(Model.Localize("Sessions") + " for " + Model.User.Name) %>
</asp:Content>
