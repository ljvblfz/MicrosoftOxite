...
<div id="sessiontags">
	<h5>Tags</h5>
	<%=Html.UnorderedList(
                tagListViewModel.Tags.OrderBy(t => t.GetDisplayName()),
                (t, i) => Html.Link(t.GetDisplayName().Ellipsize(21, s => s.CleanText()), Url.Sessions(t)), null,
