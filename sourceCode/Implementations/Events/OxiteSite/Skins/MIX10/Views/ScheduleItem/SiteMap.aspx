<%@ Page Language="C#" AutoEventWireup="true" ContentType="text/xml" Inherits="System.Web.Mvc.ViewPage<OxiteViewModelItems<ScheduleItem>>" %>
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><%
    ...
    { %>
   <url>
        <loc><%=Url.AbsolutePath(Url.Session(scheduleItem)) %></loc>
    </url><%
    } %>
</urlset>