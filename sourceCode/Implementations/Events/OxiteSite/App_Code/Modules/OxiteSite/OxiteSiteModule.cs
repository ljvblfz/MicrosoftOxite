...
namespace OxiteSite.App_Code.Modules.OxiteSite
{
    public class OxiteSiteModule : IOxiteModule
    {
        ...
        private static void registerSkinResolvers(IUnityContainer container)
        {
            ...
            skinResolverRegistry.Add(container.Resolve<OxiteSkinResolver>());
        }
        ...
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute(
                "EventSessionsMinePrintable",
                "Sessions/Mine/Printable",
                new { controller = "ScheduleItem", action = "ListByUserPrintable", eventName = eventNameValue, scheduleItemType = "Session", pagePath = "sessions" },
                externalControllerNamespaces
                );
            ...
            routes.MapRoute(
               "PDC09SessionCal",
               "MIX10/Sessions/{scheduleItemSlug}/ICS",
               new { controller = "ScheduleItem", action = "ItemIcs", eventName = eventNameValue, scheduleItemType = "Session" },
               null,
               externalControllerNamespaces
               );

            // MIX10 REST API START

            routes.MapRoute(
              "MIX10SessionsJson",
              "MIX10/Sessions/JSON",
              new { controller = "ScheduleItem", action = "ListByEventJson", eventName = eventNameValue, scheduleItemType = "Session" },
              null,
              externalControllerNamespaces
              );
            ...
            routes.MapRoute(
              "MIX10SessionsXml",
              "MIX10/Sessions/XML",
              new { controller = "ScheduleItem", action = "ListByEventXml", eventName = eventNameValue, scheduleItemType = "Session" },
              null,
              externalControllerNamespaces
              );
            ...
            routes.MapRoute(
              "MIX10SessionSlugXml",
              "MIX10/Sessions/{scheduleItemSlug}/XML",
              new { controller = "ScheduleItem", action = "ItemXml", eventName = eventNameValue, scheduleItemType = "Session" },
              null,
              externalControllerNamespaces
              );

            routes.MapRoute(
              "MIX10SessionSlugJson",
              "MIX10/Sessions/{scheduleItemSlug}/JSON",
              new { controller = "ScheduleItem", action = "ItemJson", eventName = eventNameValue, scheduleItemType = "Session" },
              null,
              externalControllerNamespaces
              );
            ...
            routes.MapRoute(
              "MIX10SpeakersJson",
              "MIX10/Speakers/JSON",
              new { controller = "Speaker", action = "ListByEventJson", eventName = eventNameValue, pagePath = "speakers" },
              null,
              externalControllerNamespaces
              );
            ...
            routes.MapRoute(
              "MIX10SpeakersXml",
              "MIX10/Speakers/XML",
              new { controller = "Speaker", action = "ListByEventXml", eventName = eventNameValue, pagePath = "speakers" },
              null,
              externalControllerNamespaces
              );
            ...
            routes.MapRoute(
             "MIX10SpeakerSlugXml",
             "MIX10/Speakers/{speakerName}/XML",
             new { controller = "Speaker", action = "ItemXml", eventName = eventNameValue, scheduleItemType = "Session" },
             new { speakerName = new IsSpeaker()},
             externalControllerNamespaces
             );

            routes.MapRoute(
              "MIX10SpeakerSlugJson",
              "MIX10/Speakers/{speakerName}/JSON",
              new { controller = "Speaker", action = "ItemJson", eventName = eventNameValue, scheduleItemType = "Session" },
              new { speakerName = new IsSpeaker()},
              externalControllerNamespaces
              );
            ...
            // [DC]: Remove when content with routes issue is resolved
            routes.MapRoute(
                "MIX10SocialArt",
                "Social/Art",
                new { controller = "Page", action = "Art", eventName = eventNameValue },
                null, pdc09ControllerNamespaces
                );

            routes.MapRoute(
               "MIX10SyncClient",
               "SyncClient",
               new { controller = "User", action = "Token", eventName = eventNameValue },
               null, externalControllerNamespaces
               );
            routes.MapRoute(
               "GetAPIToken",
               "GetAPIToken",
               new { controller = "User", action = "GetToken", eventName = eventNameValue},
               null, externalControllerNamespaces
               );

            routes.MapRoute(
                "PDC09Session",
                eventNameValue.ToUpperInvariant() + "/Sessions/{scheduleItemSlug}",
            ...
            // Live redirection
            routes.MapRoute(
                "MIX10SessionRedirect",
                "Sessions/{scheduleItemSlug}",
                new { controller = "ScheduleItem", action = "ItemRedirect", eventName = eventNameValue, scheduleItemType = "Session" },
                null, externalControllerNamespaces
                );
        ...
        public void RegisterCatchAllRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute("CurrentPress", "press", new { controller = "Redirection", action = "OldPage", path = "http://www.microsoft.com/presspass/events/mix/" },
                null);


            routes.MapRoute("Old10K", "MIXtify/TenK.aspx",
                new { controller = "Redirection", action = "OldPage", path = "http://mix10k.visitmix.com" },
                null);
            routes.MapRoute("Old10KDisplay", "MIXtify/TenKDisplay.aspx",
                new { controller = "Redirection", action = "OldPage", path = "http://mix10k.visitmix.com" },
                null);

            routes.MapRoute("Old10KGallery", "MIXtify/TenKGallery.aspx",
                new { controller = "Redirection", action = "OldPage", path = "http://mix10k.visitmix.com" },
                null);

            routes.MapRoute("MIX10RootWall", "MIX10",
                new { controller = "Redirection", action = "OldPage", path = "/" },
                null);
