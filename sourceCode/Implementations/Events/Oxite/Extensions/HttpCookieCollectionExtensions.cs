...
namespace Oxite.Extensions
{
    public static class HttpCookieCollectionExtensions
    {
        ...
        public static string GetSelectedSkin(this HttpCookieCollection cookies, bool isMobileDevice)
        {
           string skin = isMobileDevice ? "Mobile" : "Default";
           HttpCookie cookie = cookies["selectedSkin"];
        ...
        public static void SetSelectedSkin(this HttpCookieCollection cookies, string skin)
        {
           HttpCookie cookie = cookies["selectedSkin"];

           if (cookie == null)
           {
              cookie = new HttpCookie("selectedSkin");
              cookies.Add(cookie);
           }
