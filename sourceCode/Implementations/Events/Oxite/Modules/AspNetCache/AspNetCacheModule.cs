...
namespace Oxite.Modules.AspNetCache
{
    public class AspNetCacheModule : IOxiteCacheModule
    {
        ...
        public void InvalidateContains(string key, IEqualityComparer<string> comparer)
        {
        ...
        private static void insert(HttpContext context, string key, object value)
        {
            ...
            context.Cache.Insert(key, value, null, DateTime.Now.AddMinutes(15), Cache.NoSlidingExpiration);
        }
