...
{
    public class PluginStyleRegistry : List<PluginStyle>
    {
        ...
        public void Add(Plugin plugin, string url, Func<PluginStyleContext, bool> forCurrentRequest)
        {
            lock (this)
            {
                this.Add(new PluginStyle(plugin, url, forCurrentRequest));
            }
        }
