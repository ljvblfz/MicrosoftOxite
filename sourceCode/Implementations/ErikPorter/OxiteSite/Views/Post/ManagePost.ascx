...
<div class="admin manage buttons"><%
    ...
    { %>
    <a href="<%=Url.Files(Model.Item) %>" title="<%=Model.Localize("ManageFiles", "Manage Files") %>" class="ibutton files"><%=Html.SkinImage("/images/page_files.png", Model.Localize("ManageFiles", "Manage Files"), new { width = 16, height = 16 })%></a>
