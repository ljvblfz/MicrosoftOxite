<%@ Control Language="C#" AutoEventWireup="true" Inherits="System.Web.Mvc.ViewUserControl<OxiteModelItem<Oxite.Models.Page>>" %>
            ...
            <ul>
                <li class="input page">
                    <fieldset>
                        ...
                        <%
                            Oxite.Models.Page parent = Model.Container as Oxite.Models.Page != null ? (Oxite.Models.Page)Model.Container : Model.Item.Parent;
                            ...
                            ((IList) allPages.Items).Insert(0, new Oxite.Models.Page { Slug = "", ID = Guid.Empty });
                             %>
