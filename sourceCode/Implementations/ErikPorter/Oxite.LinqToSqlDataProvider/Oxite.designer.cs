...
namespace Oxite.LinqToSqlDataProvider
{
    ...
    partial void Deleteoxite_File(oxite_File instance);
		...
		public OxiteLinqToSqlDataContext() : 
				base("Data Source=localhost;Initial Catalog=Oxite.Database;Integrated Security=True", mappingSource)
		{
			OnCreated();
		}
	...
	public partial class oxite_Post : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<oxite_File> _oxite_Files;
    ...
    partial void OnSearchBodyChanged();
		...
		[Association(Name="oxite_Post_oxite_File", Storage="_oxite_Files", ThisKey="PostID", OtherKey="PostID")]
		[DataMember(Order=20, EmitDefaultValue=false)]
		public EntitySet<oxite_File> oxite_Files
		{
			get
			{
				if ((this.serializing 
							&& (this._oxite_Files.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
				return this._oxite_Files;
			}
			set
			{
				this._oxite_Files.Assign(value);
			}
		}
		...
		private void attach_oxite_Files(oxite_File entity)
		{
			this.SendPropertyChanging();
			entity.oxite_Post = this;
		}
		
		private void detach_oxite_Files(oxite_File entity)
		{
			this.SendPropertyChanging();
			entity.oxite_Post = null;
		}
		...
		private void Initialize()
		{
			...
			this._oxite_Comments = new EntitySet<oxite_Comment>(new Action<oxite_Comment>(this.attach_oxite_Comments), new Action<oxite_Comment>(this.detach_oxite_Comments));
			this._oxite_Files = new EntitySet<oxite_File>(new Action<oxite_File>(this.attach_oxite_Files), new Action<oxite_File>(this.detach_oxite_Files));
			this._oxite_User = default(EntityRef<oxite_User>);
			OnCreated();
		}
    ...
    partial void OnPostIDChanged();
		...
		[Column(Storage="_DisplayName", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		[DataMember(Order=2)]
		public string DisplayName
		{
			get
		...
		[Column(Storage="_MimeType", DbType="VarChar(MAX) NOT NULL", CanBeNull=false)]
		[DataMember(Order=4)]
		...
		[Association(Name="oxite_Post_oxite_File", Storage="_oxite_Post", ThisKey="PostID", OtherKey="PostID", IsForeignKey=true)]
		public oxite_Post oxite_Post
		{
			get
			{
			...
			set
			{
							...
							|| (this._oxite_Post.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._oxite_Post.Entity = null;
						previousValue.oxite_Files.Remove(this);
					}
					this._oxite_Post.Entity = value;
					if ((value != null))
					{
						value.oxite_Files.Add(this);
						this._PostID = value.PostID;
					}
					else
					{
