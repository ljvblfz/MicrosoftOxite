...
namespace Oxite.Extensions
{
    public static class UrlHelperExtensions
    {
        ...
        {
            return urlHelper.RouteUrl("PostsByDataFormat", new { dataFormat });
        }
        ...
        public static string Files(this UrlHelper urlHelper, Post post)
        {
            return urlHelper.RouteUrl("FilesByPost", new { areaName = post.Area.Name, slug = post.Slug });
        }

        public static string AddFile(this UrlHelper urlHelper, Post post)
        {
            return urlHelper.RouteUrl("AddFileToPost", new { areaName = post.Area.Name, slug = post.Slug });
        }

        public static string EditFile(this UrlHelper urlHelper, Post post)
        {
            return urlHelper.RouteUrl("EditFileOnPost", new { areaName = post.Area.Name, slug = post.Slug });
        }

        public static string RemoveFile(this UrlHelper urlHelper, Post post)
        {
