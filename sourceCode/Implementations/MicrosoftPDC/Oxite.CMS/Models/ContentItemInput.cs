...
namespace Oxite.Modules.CMS.Models
{
    public class ContentItemInput
    {
        ...
        public ContentItem ToContentItem(UserAuthenticated creator, Guid siteID)
        {
            return ToContentItem(creator, siteID, Guid.Empty);
        }

        public ContentItem ToContentItem(UserAuthenticated creator, Guid siteID, Guid pageID)
        {
