...
namespace Oxite.Modules.Conferences.Extensions
{
    public static class ScheduleItemExtensions
    {
        ...
        public static ScheduleItemSmall ToScheduleItemSmall(this ScheduleItem scheduleItem)
        {
            ...
            return new ScheduleItemSmall(scheduleItem.ID, scheduleItem.Event != null ? scheduleItem.Event.Name : null,
                                         scheduleItem.Slug, scheduleItem.Title);
        }
    }
}