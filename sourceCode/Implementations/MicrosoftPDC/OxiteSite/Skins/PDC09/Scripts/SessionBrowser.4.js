...
pdc.sessionBrowser = {
    ...
    "sessions": {
        ...
        "prepareTags": function() {
            ...
            var tagsDivHeight = $tags.height();

            // Hide tags div, move underneath the control bar
            $tags.hide().insertAfter("div.controlbar").data("collapsed", true);

            // Add the expand/collapse tags bar
            $("<div/>")
				.addClass("showtags")
				.text("show tags")
				.insertBefore("#sessiontags")
				.click(function(e) {
				    if ($tags.data("collapsed")) {
				        $(this).addClass("showtagsexpanded");
				        $tags
				        //		.css("overflow", "show")
							.slideDown(500)
							.data("collapsed", false);
				    } else {
				        $(this).removeClass("showtagsexpanded");
				        $tags
				        //		.css("overflow", "hidden")
							.slideUp(250)
							.data("collapsed", true);
        ...
        "setTagState": function() {
            ...
            $("#currentTag").html("Tag: <span class=\"current tag\">" + tagName + "</span>&nbsp;<a class=\"closebutton\">remove filter</a>");
