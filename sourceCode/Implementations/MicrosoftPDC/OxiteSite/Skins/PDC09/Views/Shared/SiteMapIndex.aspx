...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><%
   ...
   <sitemap>
    ...
    <sitemap><loc><%=Url.AbsolutePath("/SiteMap/Pages") %></loc></sitemap>
    <sitemap><loc><%=Url.AbsolutePath("/SiteMap/Sessions") %></loc></sitemap>
    <sitemap><loc><%=Url.AbsolutePath("/SiteMap/Speakers") %></loc></sitemap>
</sitemapindex>
