...
namespace Oxite.Modules.Comments.Models
{
    ...
    public class Comment : EntityBase
    {
        ...
        public Comment(string body, DateTime created, UserAuthenticated creator, long creatorIP, string creatorUserAgent, Language language, DateTime modified, EntityState state)
        ...
        public Comment(string body, DateTime created, UserAuthenticated creator, long creatorIP, string creatorUserAgent, Guid id, Language language, DateTime modified, CommentSmall parent, EntityState state)
            : this(id)
        {
            Body = body;
            Created = created;
