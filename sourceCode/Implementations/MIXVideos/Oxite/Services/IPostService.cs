...
namespace Oxite.Services
{
    public interface IPostService
    {
        ...
        IPageOfList<Post> GetPosts(int pageIndex, int pageSize, Area area, Tag tag, DateTime? sinceDate);
        ...
        IPageOfList<Post> GetPostsWithDrafts(int pageIndex, int pageSize, Area area);
        IList<Post> GetPosts(DateTime startDate, DateTime endDate);
        IPageOfList<Post> GetPostsByFileType(int pageIndex, int pageSize, string typeName);
        ...
        void AddPost(Post post, User creator, out ValidationStateDictionary validationState, out Post newPost);
        void AddPostWithoutTrackbacks(Post post, User creator, out ValidationStateDictionary validationState, out Post newPost);
