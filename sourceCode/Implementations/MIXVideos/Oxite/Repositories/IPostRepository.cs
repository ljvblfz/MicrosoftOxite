...
namespace Oxite.Repositories
{
    public interface IPostRepository
    {
        ...
        IQueryable<Post> GetPosts(Area area, Tag tag);
        IQueryable<Post> GetPosts(Area area, Tag tag, DateTime sinceDate);
        ...
        IQueryable<Post> GetPostsWithDrafts(Area area);
        IQueryable<Post> GetPostsByFileType(string typeName);
        IList<Post> GetPosts(DateTime startDate, DateTime endDate);
        IList<DateTime> GetPostDateGroups();
        Post GetPost(string areaName, string slug);
