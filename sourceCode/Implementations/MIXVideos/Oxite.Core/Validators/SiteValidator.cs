...
namespace Oxite.Validation
{
    public class SiteValidator : ValidatorBase<Site>
    {
        ...
        public override ValidationState Validate(Site site)
        {
            ...
            if (string.IsNullOrEmpty(site.SkinsStylesPath))
            {
                validationState.Errors.Add(CreateValidationError(site.SkinsStylesPath, "CssPath.RequiredError", "CssPath is not set."));
            }
            ...
            if (string.IsNullOrEmpty(site.SkinsScriptsPath))
            {
                validationState.Errors.Add(CreateValidationError(site.SkinsScriptsPath, "ScriptsPath.RequiredError", "ScriptsPath is not set."));
            }

            if (string.IsNullOrEmpty(site.Skin))
            {
                validationState.Errors.Add(CreateValidationError(site.Skin, "Skin.RequiredError", "Skin is not set."));
            }

            if (string.IsNullOrEmpty(site.AdminSkin))
            {
                validationState.Errors.Add(CreateValidationError(site.AdminSkin, "AdminSkin.RequiredError", "AdminSkin is not set."));
            }
