...
namespace Oxite.Controllers
{
    public class CommentController : Controller
    {
        ...
        public virtual OxiteModelList<ParentAndChild<PostBase, Comment>> ListByPost(PostAddress postAddress)
        {
        ...
        public virtual ActionResult Approve(PostAddress postAddress, Comment commentInput, string returnUri)
        {
            Post post = postService.GetPost(postAddress);
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public virtual ActionResult Remove(PostAddress postAddress, Comment commentInput, string returnUri)
        {
            Post post = postService.GetPost(postAddress);
