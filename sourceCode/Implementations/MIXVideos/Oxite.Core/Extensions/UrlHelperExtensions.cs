...
namespace Oxite.Extensions
{
    public static class UrlHelperExtensions
    {
        ...
        {
            return urlHelper.RouteUrl("PostsByArea", new { areaName = area.Name });
        }
        ...
        public static string Posts(this UrlHelper urlHelper, Area area, Tag tag)
        {
            return urlHelper.RouteUrl("PostsByAreaAndTag", new { areaName = area.Name, tagName = tag.Name });
        }

        public static string Posts(this UrlHelper urlHelper, Area area, Tag tag, string dataFormat)
        {
            return urlHelper.RouteUrl("PostsByAreaAndTag", new { areaName = area.Name, tagName = tag.Name, dataFormat });
        }
        ...
        public static string Tags(this UrlHelper urlHelper, Area area)
        {
            return urlHelper.RouteUrl("TagsByArea");
        }
        ...
        {
            return urlHelper.RouteUrl("Post", new { areaName = post.Area != null ? post.Area.Name : "", slug = post.Slug, dataFormat = "" });
        }
        ...
        {
            return urlHelper.RouteUrl("FilesByPost", new { areaName = post.Area.Name, slug = post.Slug });
        }

        public static string AddFileContentToPost(this UrlHelper urlHelper, Post post)
        {
            return urlHelper.RouteUrl("AddFileContentToPost", new { areaName = post.Area.Name, slug = post.Slug });
        }

        public static string AddFileToPost(this UrlHelper urlHelper, Post post)
        {
            return urlHelper.RouteUrl("AddFileToPost", new { areaName = post.Area.Name, slug = post.Slug });
        }

        public static string EditFileOnPost(this UrlHelper urlHelper, Post post)
        {
            return urlHelper.RouteUrl("EditFileOnPost", new { areaName = post.Area.Name, slug = post.Slug });
        }

        public static string RemoveFileFromPost(this UrlHelper urlHelper, Post post)
        {
            return urlHelper.RouteUrl("RemoveFileFromPost", new { areaName = post.Area.Name, slug = post.Slug });
        }
        ...
        {
            return urlHelper.RouteUrl("PostCommentPermalink", new { areaName = post.Area.Name, slug = post.Slug, comment = comment.GetSlug() });
        }
        ...
        public static string CommentPending(this UrlHelper urlHelper, Post post, Comment comment)
        {
            ...
            return string.Format("{0}#comment", urlHelper.RouteUrl("Post", new { areaName = post.Area.Name, slug = post.Slug, pending = bool.TrueString }));
        }
        ...
        public static string PluginsInstall(this UrlHelper urlHelper)
        {
            return urlHelper.RouteUrl("PluginsInstall");
        }

        public static string Plugin(this UrlHelper urlHelper, Oxite.BackgroundServices.IBackgroundService plugin)
        {
        ...
        public static string CompressUrl(this UrlHelper urlHelper, string absoluteUrlEncoded)
        {
            ...
            if (string.IsNullOrEmpty(url))
            {
                ...
                catch
                {
                    ...
                    cache.Add(cacheKey, url, null, DateTime.Now.AddMinutes(30), Cache.NoSlidingExpiration, CacheItemPriority.Normal, null);
                }
