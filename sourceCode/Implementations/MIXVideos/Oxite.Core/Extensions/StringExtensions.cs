...
namespace Oxite.Extensions
{
    public static class StringExtensions
    {
        ...
        public static string CleanCssClassName(this string s)
        {
            ...
            return exp.Replace(s, "_").ToLower(System.Globalization.CultureInfo.CurrentCulture);
        }
        ...
        public static string Ellipsize(this string s, int characterCount)
        {
            return s.Ellipsize(characterCount, " ...");
        }

        public static string Ellipsize(this string s, int characterCount, string ellipsis)
        {
            ++characterCount;
            string text = !string.IsNullOrEmpty(s) ? s.CleanHtmlTags().CleanWhitespace() : "";
            ...
            if (!string.IsNullOrEmpty(text) && characterCount > 0 && text.Length >= characterCount)
            {
                ...
                return string.Join(" ", words.Take(words.Length - 1).ToArray()) + ellipsis;
            }
        ...
        {
            string hash = value = value.Trim().ToLower();
