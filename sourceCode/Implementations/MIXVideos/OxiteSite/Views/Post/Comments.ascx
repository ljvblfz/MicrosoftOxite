...
<div id="comments"><% 
	...
	Html.RenderPartialFromSkin("CommentListMedium", new OxiteModelList<ParentAndChild<PostBase, Comment>> { List = Model.Item.Comments.Select(c => new ParentAndChild<PostBase, Comment> { Parent = Model.Item, Child = c }).ToList(), Container = Model.Container, Site = Model.Site, User = Model.User }); %><%
