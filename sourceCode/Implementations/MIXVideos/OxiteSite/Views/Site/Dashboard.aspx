<%@ Page Language="C#" MasterPageFile="../Shared/Admin.Master" Inherits="System.Web.Mvc.ViewPage<OxiteModel>" %>
    ...
    <div id="dashboard">
        <ul id="data">
            <li id="recentPosts">
                ...
                <% Html.RenderPartialFromSkin("PostListSmall", new OxiteModelList<Post> { List = adminData.Posts, Site = Model.Site }); %>
            ...
            <li id="recentComments">
                ...
                <% Html.RenderPartialFromSkin("CommentListSmall", new OxiteModelList<ParentAndChild<PostBase, Comment>> { List = adminData.Comments, Site = Model.Site, User = Model.User }); %>
