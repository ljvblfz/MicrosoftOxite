...
namespace OxiteSite
{
    public class MIXVideosServiceHostFactory : ServiceHostFactory
    {
        private readonly IUnityContainer container;

        public MIXVideosServiceHostFactory()
        {
            // This service runs parallel to the main Oxite application so it needs to set up and configure it's own Unity container
            container = new MIXVideosContainerFactory().GetOxiteContainer();
        }
