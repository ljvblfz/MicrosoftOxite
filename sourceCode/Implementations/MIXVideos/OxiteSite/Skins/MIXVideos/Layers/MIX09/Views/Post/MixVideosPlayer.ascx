...
<%@ Import Namespace="Oxite.Models.Extensions" %><%
    ...
    <object class="player" width="<%=videoWidth %>" height="<%=videoHeight %>" type="application/x-silverlight-2" data="data:application/x-silverlight-2,">
        ...
        <param value="m=<%=Model.PartialModel.Media.Url %>,thumbnail=<%=videoThumbnail %>,autohide=true,showembed=true,advertisement=<%=Model.PartialModel.AdvertisementUrl %>" name="initParams" />
