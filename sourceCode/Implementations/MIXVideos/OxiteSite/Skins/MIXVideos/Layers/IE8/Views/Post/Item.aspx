...
<div class="sections">
    <div class="primary">
        <div class="<%=postClassName %>">
            ...
            <div class="addlinks">
                <%=Html.UnorderedList(Model.GetModelItem<SidebarViewModel>().Posts, (p, i) => Html.Link(p.Title, Url.Post(p)), (string)null, p => p.ID == Model.Item.ID ? "selected" : (string)null, null) %>
            </div>
