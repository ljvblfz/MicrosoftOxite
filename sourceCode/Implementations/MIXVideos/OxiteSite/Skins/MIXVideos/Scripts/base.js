...
$(document).ready(function() {
    $("ul.medium li.post,ul.small li.comment,ul.small li.post,ul.medium li.comment.pendingapproval,ul.medium li.comment.normal").each(function() {
        $(this).hoverClassIfy();
        $(this).clickClassIfy();
    });
});
...
/** expand .posts.medium .post details **/
$(document).ready(function() {
    $("ul.medium li.post").hover(
        function() {
            $("div.details", this).slideDown(200);
        },
        function(ev) {
            $("div.details", this).slideUp(200);
        }
    );
});
